...
class _MyBookinglistScreenState extends State<MyBookinglistScreen> {
  ...
  getMessageCount() async {
    ...
    request.fields
        .addAll({'user_id': '${vendorId.toString()}', 'type': "provider"});
      ...
      if (jsonResponse.responseCode == "1") {
        if (value == 'accept') {
          Fluttertoast.showToast(
              msg:
                  " Booking Accepted Successfully, You can now chat with ${name}");
        } else {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: RefreshIndicator(
          onRefresh: () {
            setState(() {
              getVendorBooking("Completed");
            });
            return getVendorBooking("Completed");
          },
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  currentIndex == 0
                      ? FutureBuilder(
                          future: getVendorBooking("Completed"),
                          builder:
  ...
  Widget getAcceptRejectButton(
      {String? value, String? bookingId, int? i, String? name}) {
    /* print(
            ...
            children: [
              ...
              InkWell(
                onTap: () => MYDialog.showAlertDialogWithTwobtn(context,
                    ...
                    body: "",
                    funtionName: () => acceptReject(
                        status: "accept", id: bookingId, name: name)),
                child: Container(
                  width: 32.77.w,
                  height: 4.92.h,
                  //margin: EdgeInsets.only(right: 2.w),
    ...
    request.fields.addAll({
      ...
      'status': selectedValue == "Pending"
          ...
          : selectedValue == "Confirm"
              ? "2"
              : selectedValue == "Cancelled by user"
                  ? "3"
                  : selectedValue == "Cancelled by vendor"
                      ? "4"
