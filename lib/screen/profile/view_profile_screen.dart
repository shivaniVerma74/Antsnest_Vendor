        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              text(
                "${DateFormat('dd-MM-yyyy').format(/*DateTime.parse(widget.response.user?.jsonData?.birthday.toString() ??*/ DateTime.now())}",
                textColor: Color(0xff202442),
                fontSize: 10.sp,
                fontFamily: fontBold,
              ),
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              widget.response.user!.jsonData!.language == null ||   widget.response.user!.jsonData!.language == "" ? text("") : text(
